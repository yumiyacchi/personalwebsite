...
const Hero = () => {
  return (
    <section className="hero-section">
      <div className="hero-top">
        ...
        <div className="intro-text">
          <p>
            ...
            lanzamientos en mercados en el extranjero como Asia, Europa y USA, yumiyacchi se
      ...
      <div className="hero-bottom bg-gray-900 p-0 m-0">
        <iframe
          ...
          className="w-full h-auto border-0 rounded-none bg-transparent"
          style={{border: 'none', borderRadius: '12px', backgroundColor: 'transparent'}}
  ></iframe>
      </div>
      <div>
